...
from app.services.otp_delivery import send_otp_code
...
async def _request_otp(
    ...
    *,
    ...
    debug_otp_code = otp_code if settings.debug else None
    ...
    *,
    ...
    if otp_record is None:
        raise HTTPException(
            ...
            detail="No active OTP was found for this phone number.",
        )
